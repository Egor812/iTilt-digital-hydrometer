...
#endif
#ifdef ESP32
  char i2c_sda_pin[3]="15";
  char i2c_scl_pin[3]="21";
#endif
...
{ 
  ...
  if (SPIFFS.begin()) {
    ...
    digitalWrite(atoi(power_pin2),HIGH);
  #endif
  ...
  if ((tilt<95 and tilt>85) or tilt<12 or String(tilt)=="nan")  //Condition to run The Wifi Manager portal.  
  {
    ...
    WiFiManagerParameter custom_mqtt_service("service", "MQTT SERVICE (CAYENNE, UBIDOTS OR ADAFRUIT SUPORTED)", mqtt_service, 21);    //****************************
